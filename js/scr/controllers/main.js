...
function thongTinNhanVien(isAdd) {
    ...
    isValid &= test.kiemTraRong(gioLam, "tbGiolam", "Vui lòng nhập giờ làm") && test.kiemTraSo(gioLam, "tbGiolam", "Giờ làm phải là số") && test.kiemTraLuong_GioLam(gioLam, "tbGiolam", "Số giờ làm ít nhất là 80h và nhiều nhất là 120h", 80, 200)
